...
function TaskflowConcept() {
    return (
        <div>
            <section id="taskFlowConcept" className='my-3 md:my-8 min-h-screen w-[95vw] overflow-x-hidden md:px-4 rounded-lg py-3 md:py-6 mx-auto'>
                ...
                <div className="narrowTaskflow my-12 bg-white w-full mx-auto shadow-xl shadow-gray-400 rounded-xl flex flex-col md:flex-row items-center justify-center gap-4 px-3 md:py-8">
