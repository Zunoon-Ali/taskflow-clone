...
function Header() {
    ...
    return (
        <section id='header' className='sticky top-0 left-0 bg-white z-50 '>
            <div className="flex justify-around items-center px-0 md:px-5 md:py-6 py-2 w-full md:mt-0 mt-2">
                <div className="logo">
                    <img src="./task-flow-logo.png" alt="Taskflow" className='w-92 md:w-78 md:mr-40 p-0 text-start' />
                </div>
                <nav className="nav-service-link relative">
                    <div className="hamburger block md:hidden">
                        <GiHamburgerMenu className='text-4xl text-blue-500 bg-gray-300 p-2 rounded-sm' onClick={() => setIsOpen(!isOpen)} />
                    </div>
