        ...
        <div>
            <section id="blbl" className='my-3 md:my-12 min-h-screen w-[95vw] overflow-x-hidden bg-white shadow-xl shadow-gray-400 md:py-6 py-3 mx-auto'>
                ...
                <div className="flex flex-col md:flex-row px-5 items-center justify-center mx-auto">
                    ...
                    <div className="blblContent flex flex-col items-center justify-center gap-4 md:w-[350px]">
                        <p className='text-xl md:text-2xl text-gray-800 mt-4'>Select a layout that perfectly matches your project.</p>
                        <p className='text-xl md:text-2xl text-gray-800 mt-2 mb-8'><b className='text-blue-500'>Sectioned</b> List and <b className='text-blue-500'>Board pipeline</b> (Kanban) are here to suit your workflow.</p>
                    </div>
                    <img src="./taskflow-list-board.webp" alt="list of boards" className='w-full md:w-1/2 my-8' />
                </div>
            </section>
        </div>
    )
