...
function MultipleProjectTask() {
    return (
        ...
        >
            <div
                className="multipleProjectContainer flex flex-col md:flex-row items-center justify-center bg-white rounded-xl py-12 gap-8 shadow-xl shadow-gray-400 px-8"
            >
                <div
