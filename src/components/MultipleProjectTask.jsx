            ...
            >
                ...
                >
                    <div className="multipleProjectHeading flex items-center gap-4 mb-6">
                        <TbArrowFork className="text-5xl md:text-6xl text-white bg-blue-500 rounded-full p-1 md:p-3
                        font-bold" />
                        <h1 className="text-4xl md:text-5xl font-medium text-gray-800">
                            Multiple Project Tasks
                        </h1>
                    </div> 
                    <p className="text-xl md:text-2xl text-gray-800 text-start leading-8 font-semibold">
                        Add a task to several projects.
                        <br /> Section and reorder within each project.
                        <br /><br />
                        <span className="text-gray-800 ">Flexible. Structured. <b>Done</b>.</span>
                    </p>
                </div>
                ...
                <img
                    ...
                    className="md:w-[20vw] w-full rounded-lg shadow-md"
                    data-aos="fade-left"
                    data-aos-delay="400"
                    data-aos-duration="1000"
                    loading="lazy"
