  ...
  return (
    <div>
      <section
        ...
        className='my-3 md:my-8 min-h-screen w-[95vw] overflow-x-hidden md:py-6 py-3 mx-auto'
        data-aos="fade-up"
      ...
      >
        <div className="substackAttachmentContainer flex flex-col md:flex-row items-center justify-between mx-auto gap-5 max-w-6xl">
          ...
          <div
            className="rightDragDrop min-h-[400px] flex flex-col items-center justify-between w-full md:w-1/2 bg-white shadow-lg shadow-gray-400 rounded-xl my-5"
            data-aos="fade-left"
            data-aos-delay="400"
            data-aos-duration="1000"
          >
            <div className="dragDrop mt-4 mb-5" data-aos="zoom-in-up" data-aos-delay="600" data-aos-duration="800">
