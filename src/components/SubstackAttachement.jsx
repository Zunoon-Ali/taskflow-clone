...
function SubstackAttachement() {
  return (
    <div>
      <section id='substackAttachment' className='my-3 md:my-12 min-h-screen w-full overflow-x-hidden  md:py-12 py-3'>
        <div className="substackAttachmentContainer flex flex-col md:flex-row items-center justify-between mx-auto gap-5 max-w-6xl">
          <div className="leftSubstackAttachment min-h-[400px] flex flex-col items-center justify-between w-full md:w-1/2 bg-white shadow-lg shadow-gray-400 rounded-xl my-5 overflow-hidden" >
            <h1 className="text-3xl md:text-4xl font-semibold text-gray-800 mt-6 mb-16 leading-tight flex items-center ">
              <ImAttachment className="text-4xl md:text-5xl mr-4 bg-blue-600 text-white rounded-full p-2" />
              Subtasks and Attachments
            </h1>
            <img
              src="./Subtasks-and-Attachments-iPhone.webp"
              alt="Substack Attachment"
    ...
    twe     <div className="dragDrop mt-4 mb-5">
